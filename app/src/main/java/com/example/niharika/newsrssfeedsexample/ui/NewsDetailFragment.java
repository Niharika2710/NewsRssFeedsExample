...
/**
 * Created by Niharika on 5/31/2016.
 */
public class NewsDetailFragment extends Fragment implements
    ...
    public static NewsDetailFragment newInstance(long itemId) {
    ...
    private void bindViews() {
        ...
        ImageView imageView = (ImageView) mRootView.findViewById(R.id.photo);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return NewsLoader.newInstanceForItemId(getActivity(), mItemId);
    }
